...
if (mouseOver == 0) {
   document.getElementById('daLine').style.animation = "none"
   document.getElementById('daLine').style.strokeWidth = "3%"
   document.getElementById('daLine').style.opacity = "1"
 ...
 function onMouseOverOut() { 
   document.getElementById('daLine').style.opacity = "0"
   document.getElementById('daLine').style.animation = "aniLine .75s linear reverse"
   document.getElementById("container").append(daSVG)
   mouseOver = 0
   }
...
function getMouse(evt){
 ...
 function doUpdate(){
   ...
   //  console.log(newPX)
    ...
    document.getElementById('daLine').setAttributeNS(null, 'x1', newPX)
    document.getElementById('daLine').setAttributeNS(null, 'x2', newPX)
    document.getElementById('daLine').style.opacity = "0"
    document.getElementById('daLine').style.animation = "aniLine .75s linear reverse"
